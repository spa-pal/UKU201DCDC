...
#define MCP2515_CS_ON       GPIOC->CRH&=~0x0000000f;GPIOC->CRH|=0x00000003;GPIOC->ODR&=~(1<<8);
#define MCP2515_CS_OFF      GPIOC->CRH&=~0x0000000f;GPIOC->CRH|=0x00000003;GPIOC->ODR|=(1<<8);
